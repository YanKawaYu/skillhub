...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/internal/hunterdock/provision"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/internal/hunterdock/namespaces/reconcile"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/me/namespaces"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/me/namespaces"),
